...
class HomeScreen extends StatelessWidget {
  ...
  static const List<Map<String, String>> categories = [
    {
      'title': 'iMac',
      'imageUrl': 'https://images.unsplash.com/photo-1527864550417-7f91a4d4d85d?w=150&h=150&fit=crop&crop=center',
    },
    {
      'title': 'Games',
      'imageUrl': 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=150&h=150&fit=crop&crop=center',
    },
    {
      'title': 'Headphones',
    ...
    {
      'title': 'Speaker',
      'imageUrl': 'https://images.unsplash.com/photo-1608043152269-423dbba4e7e1?w=150&h=150&fit=crop&crop=center',
    },
    {
      'title': 'Airpods',
      'imageUrl': 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=150&h=150&fit=crop&crop=center',
    },
    {
      'title': 'Laptop',
      'imageUrl': 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=150&h=150&fit=crop&crop=center',
    },
  ];
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ImageScolingWidget(
                  imageList: ['https://static.vecteezy.com/system/resources/previews/020/737/706/non_2x/web-banner-or-horizontal-template-design-with-special-offer-on-mobile-phones-for-advertising-concept-vector.jpg', 'https://tse4.mm.bing.net/th/id/OIP.yVGDg2ygsSNXfoA1pLwVNAHaEK?cb=12&rs=1&pid=ImgDetMain&o=7&rm=3', 'https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/77f7c336776659.5728f30441a89.jpg'],
                  screenHeight: height,
                  screenWidth: width,
                  show: true,
                ),
                 ...
                 ConstantWidgets.hight10(context),
                                 ...
                                 child: CategoryCard(
                                   ...
                                   onTap: () {
                                     ScaffoldMessenger.of(context).showSnackBar(
                                       SnackBar(
                                         content: Text('${categories[index]['title']} tapped!'),
                  ...
                  BlocProvider(
                    create: (context) => BrandScrollCubit(brandList: BrandData.brands),
                    child: SizedBox(
                            height: 30,
